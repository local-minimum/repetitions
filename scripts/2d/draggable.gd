...
var _drag_grid_origin: Vector2i

signal on_drag_end(from: Vector2i, to: Vector2i)
...
func _handle_drag_start(node: Node2D) -> void:
    ...
    _dragging = node
    _drag_grid_origin = _coordinates
...
func _emit_drag_end(_node: Node2D) -> void:    
    # TODO: Figure this out!
    on_drag_end.emit(_drag_grid_origin, _drag_grid_origin)
